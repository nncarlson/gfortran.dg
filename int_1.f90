...
program test_int
   ...
   if (i4 /= -3_ik4 .or. i8 /= -3_ik8) stop 1

   i1 = int(5,  ik1)
   i2 = int(i1, ik2)
   i4 = int(i1, ik4)
   i8 = int(i1, ik8)
   if (i1 /= 5_ik1 .or. i2 /= 5_ik2) stop 1
   if (i4 /= 5_ik4 .or. i8 /= 5_ik8) stop 1

   i8 = int(10, ik8)
   i1 = int(i8, ik1)
   i2 = int(i8, ik2)
   i4 = int(i8, ik4)
   if (i1 /= 10_ik1 .or. i2 /= 10_ik2) stop 1
   if (i4 /= 10_ik4 .or. i8 /= 10_ik8) stop 1
   !
   ! case 2(b)
   !
   r4 = -3.7_sp
   ...
   i4 = int(r4, ik4)
   i8 = int(r4, ik8)
   if (i1 /= 0_ik1 .or. i2 /= 0_ik2) stop 1
   if (i4 /= 0_ik4 .or. i8 /= 0_ik8) stop 1
   ...
   i4 = int(o'0011', ik4)
   i8 = int(o'0011', ik8)
   if (i1 /= 9_ik1 .or. i2 /= 9_ik2) stop 1
   if (i4 /= 9_ik4 .or. i8 /= 9_ik8) stop 1
   i1 = int(z'0011', ik1)
   i2 = int(z'0011', ik2)
   i4 = int(z'0011', ik4)
   i8 = int(z'0011', ik8)
   if (i1 /= 17_ik1 .or. i2 /= 17_ik2) stop 1
   if (i4 /= 17_ik4 .or. i8 /= 17_ik8) stop 1
