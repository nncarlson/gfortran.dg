...
program main
  ...
  if (any(i2 /= (/ 3, 1, 2 /))) stop 1

  i4 = (/ -1, 1, -3 /)
  call sub_i4(i4(1:3:2))
  if (any(i4 /= (/ 3, 1, 2 /))) stop 1

  i8 = (/ -1, 1, -3 /)
  call sub_i8(i8(1:3:2))
  if (any(i8 /= (/ 3, 1, 2 /))) stop 1

  r4 = (/ -1.0, 1.0, -3.0 /)
  call sub_r4(r4(1:3:2))
  if (any(r4 /= (/ 3.0, 1.0, 2.0/))) stop 1

  r8 = (/ -1.0_8, 1.0_8, -3.0_8 /)
  call sub_r8(r8(1:3:2))
  if (any(r8 /= (/ 3.0_8, 1.0_8, 2.0_8/))) stop 1

  c4 = (/ (-1.0_4, 0._4), (1.0_4, 0._4), (-3.0_4, 0._4) /)
  call sub_c4(c4(1:3:2))
  if (any(real(c4) /= (/ 3.0_4, 1.0_4, 2.0_4/))) stop 1
  if (any(aimag(c4) /= 0._4)) stop 1

  c8 = (/ (-1.0_4, 0._4), (1.0_4, 0._4), (-3.0_4, 0._4) /)
  call sub_c8(c8(1:3:2))
  if (any(real(c8) /= (/ 3.0_4, 1.0_4, 2.0_4/))) stop 1
  if (any(aimag(c8) /= 0._4)) stop 1

  d_i8%v = (/ -1, 1, -3 /)
  call sub_d_i8(d_i8(1:3:2))
  if (any(d_i8%v /= (/ 3, 1, 2 /))) stop 1
...
subroutine sub_c8(r)
  ...
  if (r(1) /= (-1._8,0._8)) stop 1
  if (r(2) /= (-3._8,0._8)) stop 1
  r(1) = 3._8
  r(2) = 2._8
...
subroutine sub_c4(r)
  ...
  if (r(1) /= (-1._4,0._4)) stop 1
  if (r(2) /= (-3._4,0._4)) stop 1
  r(1) = 3._4
  r(2) = 2._4
