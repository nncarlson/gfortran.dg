...
program char4_iunit_1
  ...
  write(string,*) 12345
  if (string .ne. 4_"       12345                              ") stop 1
  write(string, '(i6,5x,i8,a5)') 78932, 123456, "abc"
  if (string .ne. 4_" 78932       123456  abc                  ") stop 1
  write(string, *) .true., .false. , .true.
  if (string .ne. 4_" T F T                                    ") stop 1
  write(string, *) 1.2345e-06, 4.2846e+10_8
  if (string .ne. 4_"   1.23450002E-06   42846000000.000000      ") stop 1
  write(string, *) nan, inf
  if (string .ne. 4_"              NaN         Infinity    ") stop 1
  write(string, '(10x,f3.1,3x,f9.1)') nan, inf
  if (string .ne. 4_"          NaN    Infinity             ") stop 1
  write(string, *) (1.2, 3.4 )
  if (string .ne. 4_"             (1.20000005,3.40000010)") stop 1
