...
PROGRAM TestInfinite
  ...
  if (bit_pattern_PosInf_i8_hex /= bit_pattern_PosInf_i8) stop 1

  r = transfer(bit_pattern_PosInf_i8,r)
  if (r /= 1.0_r8_/0.0_r8_) stop 1
  i = transfer(r,i)
  if (bit_pattern_PosInf_i8 /= i) stop 1  

  r = transfer(bit_pattern_NegInf_i8,r)
  if (r /= -1.0_r8_/0.0_r8_) stop 1
  i = transfer(r,i)
  if (bit_pattern_NegInf_i8 /= i) stop 1

  r = transfer(bit_pattern_PosInf_i8_p,r)
  if (r /= 1.0_r8_/0.0_r8_) stop 1
  i = transfer(r,i)
  if (bit_pattern_PosInf_i8_p /= i) stop 1

  r = transfer(bit_pattern_NegInf_i8_p,r)
  if (r /= -1.0_r8_/0.0_r8_) stop 1
  i = transfer(r,i)
  if (bit_pattern_NegInf_i8_p /= i) stop 1
