...
contains
  ...
  subroutine character16_to_dt
    ...
    dt2 = transfer (c2, dt2);
    if (any (dt1(1)%x .ne. dt2(1)%x)) stop 1
    if (any (dt1(2)%x .ne. dt2(2)%x)) stop 1
