...
if (abs (SNORM2([real :: 1, 2, 3],3) - NORM2([real :: 1, 2, 3])) &
    > epsilon(0.0)*SNORM2([real :: 1, 2, 3],3)) stop 1

if (NORM2([real :: ]) /= 0.0) stop 1
if (abs (NORM2([real :: 0, 0, 3, 0]) - 3.0) > epsilon(0.0)) stop 1
...
if (abs (SNORM2(b,3) - NORM2(b)) &
    > epsilon(0.0)*SNORM2(b,3)) stop 1

if (abs (SNORM2(c,4) - NORM2(c)) &
    > epsilon(0.0)*SNORM2(c,4)) stop 1
