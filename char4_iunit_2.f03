...
program char4_iunit_2
  ...
  write(widestring,'(2x,i4,tl3,1x,f10.5,1x,a9,1x,a15)')i, x, str_default,&
   trim(str_char4)
  if (widestring .ne. k_"   3  52.54300 0 hijklmn p qwertyuiopasd") stop 1
  write(skinnystring,'(2x,i4,tl3,1x,f10.5,1x,a9,1x,a15)')i, x, str_default,&
   trim(str_char4)
  if (skinnystring .ne. "   3  52.54300 0 hijklmn p qwertyuiopasd") stop 1
  write(widestring,*)"test",i, x, str_default,&
   trim(str_char4)
  if (widestring .ne. &
    k_" test         345   52.5429993     0 hijklmnp qwertyuiopasd") stop 1
