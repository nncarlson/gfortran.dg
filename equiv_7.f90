...
!
  if (bigendian) then
    ...
    if (d1mach_little (2) .ne. transfer ((/-1_4,2146435071_4/), 1d0)) stop 1
  else
    if (d1mach_big (1) .ne. transfer ((/1048576_4, 0_4/), 1d0)) stop 1
    if (d1mach_big (2) .ne. transfer ((/2146435071_4,-1_4/), 1d0)) stop 1
  end if 
!
contains
  ...
  subroutine real4_real4
      ...
      data (a(i), i=1,2) /1.0_4, 2.0_4/, &
            a(4) /4.0_4/
      if (sum (abs (a -  &
          (/1.0_4, 2.0_4, 3.0_4, 4.0_4/))) > 1.0e-6) stop 1
  ...
  subroutine complex_real
      ...
      if (sum (abs (a - (/(0.0_4, 1.0_4),(2.0_4, 0.0_4), &
          (3.0_4, 4.0_4),(0.0_4, 5.0_4)/)))  > 1.0e-6) stop 1
  end subroutine complex_real
  subroutine check_block_data
      common /global/ ca (4)
      equivalence (ca(3), cb)
      integer(4) ca
      if (any (ca .ne. (/42, 43, 99, 44/))) stop 1
