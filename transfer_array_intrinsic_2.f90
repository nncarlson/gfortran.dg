...
! Check assumed shape.
     ...
     if (any (ic .ne. transfer (ch1, ic))) stop 1

! Check assumed character length.

     if (any (ic .ne. transfer (ch2, ic))) stop 1

! Check automatic character length.

     if (any (ic .ne. transfer (ch3, ic))) stop 1
