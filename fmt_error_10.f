...
! Test case prepared by Jerry DeLisle <jvdelisle@gcc.gnu.org>
      ...
      if (line.ne."   1.000000000000000D+001.E+00") stop 1
      ...
      if (istat.ne.5006 .or. msg(1:15).ne."Positive width ") stop 1
      read (*,str,iostat=istat, iomsg=msg) x
      if (istat.ne.5006 .or. msg(1:15).ne."Positive width ") stop 1
      if (x.ne.555.25) stop 1
      
      write (line,'(1pd24.15e11.3)') 1.0d0, 1.234
      if (line.ne."   1.000000000000000D+00  1.234E+00") stop 1
