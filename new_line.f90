...
program new_line_check
  ...
  if (iachar(new_line(a1)) /= 10) stop 1
  if (iachar(new_line(a2)) /= 10) stop 1
  if (iachar(new_line(a3)) /= 10) stop 1
  if (iachar(new_line(a4)) /= 10) stop 1
  if (iachar(new_line(a5)) /= 10) stop 1
