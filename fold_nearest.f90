...
if (nearest (x(2), dir(2)) /= nearest (a(2), dir(2))) stop 1
if (nearest (x(3), dir(3)) /= nearest (a(3), dir(3))) stop 1
if (nearest (x(4), dir(4)) /= nearest (a(4), dir(4))) stop 1
if (nearest (x(5), dir(5)) /= nearest (a(5), dir(5))) stop 1
if (nearest (x(6), dir(6)) /= nearest (a(6), dir(6))) stop 1
if (nearest (x(7), dir(7)) /= nearest (a(7), dir(7))) stop 1
if (nearest (x(8), dir(8)) /= nearest (a(8), dir(8))) stop 1
...
!if (nearest (x(9), dir(9)) /= nearest (a(9), dir(9))) stop 1
!if (nearest (x(10), dir(10)) /= nearest (a(10), dir(10))) stop 1
