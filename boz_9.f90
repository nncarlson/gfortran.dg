...
if (rc  /= 2.732958e10) stop 1
if (dc /= 0.30102999566398120d0) stop 1
if (real(z1c) /= -1.242908e1 .or. aimag(z1c) /= 3.049426e-10) stop 1
if (real(z2c) /= 4.160326e16 .or. aimag(z2c) /= 5.343285e-7) stop 1

if (r2 /= 13107.0) stop 1
if (r  /= 2.732958e10) stop 1
if (d /= 0.30102999566398120d0) stop 1
if (real(z1) /= -1.242908e1 .or. aimag(z1) /= 3.049426e-10) stop 1
if (real(z2) /= 4.160326e16 .or. aimag(z2) /= 5.343285e-7) stop 1
...
if (rc  /= -3.72356884822177915d-103) stop 1
if (real(z1c) /= 3.05175781249999627d-5 .or. aimag(z1c) /= -4.0) stop 1
if (real(z2c) /= 5.0 .or. aimag(z2c) /= 3.98227593015308981d41) stop 1

if (r2 /= 1099511575347.0d0) stop 1
if (r  /= -3.72356884822177915d-103) stop 1
if (real(z1) /= 3.05175781249999627d-5 .or. aimag(z1) /= -4.0) stop 1
if (real(z2) /= 5.0 .or. aimag(z2) /= 3.98227593015308981d41) stop 1
