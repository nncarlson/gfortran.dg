...
program countem
  ...
  if (count1.ne.-127.or.rrate4.ne.0.0.or.mymax4.ne.0) stop 1
  call system_clock(count=count2, count_rate=irate2, count_max=mymax2)
  if (count2.ne.-32767.or.irate2.ne.0.or.mymax2.ne.0) stop 1
  call system_clock(count=count2, count_rate=rrate4, count_max=mymax2)
  if (count2.ne.-32767.or.rrate4.ne.0.0.or.mymax2.ne.0) stop 1
  call system_clock(count=count4, count_rate=irate4, count_max=mymax4)
  if (irate4.ne.1000.or.mymax4.ne.huge(0_4)) stop 1
  call system_clock(count=count4, count_rate=rrate4, count_max=mymax4)
  if (rrate4.ne.1000.0.or.mymax4.ne.huge(0_4)) stop 1
end program countem
